...
const { searchExhUser, filterExhibitions, getVolunteersByExhId, getSponsorsByExhId, 
    getStaffsByExhId, getStaffById, findAll, getTicket, getTicketAdmin, getTransaction, getTransactionCustomer } = require("../services/query.service");
...
router.get("/find-transaction", getTransaction);
router.get("/find-transaction-customer", getTransactionCustomer);
